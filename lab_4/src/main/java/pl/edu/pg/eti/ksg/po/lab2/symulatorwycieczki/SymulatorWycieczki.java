...
public class SymulatorWycieczki {
    ...
    private Set<SluchaszPostepow> sluchaczePostepow = new HashSet<>(); 
    ...
    public void dodajSluchacza(SluchaszPostepow sluchacz) {
    ...
    public void symuluj() {
        ...
        for(pozycjaGrupy = 0; pozycjaGrupy < wycieczka.getLiczbaElementowWycieczki(); pozycjaGrupy++) {
            ...
            if(elementWycieczki instanceof Wedrowka) {
                ...
                for(Uczestnik u : grupa.getUczestnicy()) {
                    u.reagujNaAtrakcje(atrakcja, atrakcja.getCzas());
                }
            }
            
        for(SluchaszPostepow u : sluchaczePostepow) {
            u.aktualizujPostep(elementWycieczki, pozycjaGrupy, wycieczka.getLiczbaElementowWycieczki());
        }
    }
